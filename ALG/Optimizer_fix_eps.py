...
class ALG():
    ...
    def line_search_one_step(self, gamma1:float=0.9,gamma2=0.9, gamma3=1e-3, b:int=None, N:int=1, method:str='LS-GS-GDA', min_b:int=1, force_b:int=-1, kernal='AGDA',\
                             isChangeOpt = True, isRestart = True, mu_coeff = 1,\
        ...
        for s in range(self.sim_time):
            ...
            while True:
                ...
                def backtrack(gamma1,gamma2):
                    ...
                    f['k'] = computeGrad(self.model_bk,data_by_batch,target_by_batch, batch_index,b,isOnestepmethod=True)
                    ...
                    while True:
                        ...
                        while l<=L:
                            ...
                            def ASGDA_X(lr_x,lr_y):
                                ...
                                self.model_bk.zero_grad()
                                f['k+1,k'] = computeGrad(self.model_bk,data_by_batch,target_by_batch, batch_index,b,isOnestepmethod=True)
                            ...
                            #compute the gradients of current model using batches, not that the batch does not change here
                            self.model_bk.zero_grad()
                            f['k+1'] = computeGrad(self.model_bk,data_by_batch,target_by_batch, batch_index,b,isOnestepmethod=True)
                            ...
                            self.model_bk.zero_grad()
                            f['k,k+1'] = computeGrad(self.model_bk,data_by_batch,target_by_batch, batch_index,b,isOnestepmethod=True)
